...
<html>
<body>
	<div class="modal fade" id="student_export_project" tabindex="-1"
						...
						<div id="check" class="checkbox">
							...
							<ul class="group-list">
								...
								<li><button value="5" class="btn btn-info btn-sm pro">
										<i class="fa fa-times" aria-hidden="true"></i> <span>负责人工号</span>
									</button></li>
								<li><button value="6" class="btn btn-info btn-sm pro">
										<i class="fa fa-times" aria-hidden="true"></i> <span>负责人名称</span>
									</button></li>
							</ul>
						</div>
