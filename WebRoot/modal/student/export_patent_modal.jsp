...
<html>
<body>
	<div class="modal fade" id="student_export_patent" tabindex="-1"
						...
						<div id="check" class="checkbox">
							...
							<ul class="group-list">
								...
								<li><button value="4" class="btn btn-info btn-sm pro">
										<i class="fa fa-times" aria-hidden="true"></i> <span>类别</span>
									</button></li>
								...
								<li><button value="6" class="btn btn-info btn-sm pro">
										<i class="fa fa-times" aria-hidden="true"></i> <span>获批时间</span>
									</button></li>
								<li><button value="7" class="btn btn-info btn-sm pro">
										<i class="fa fa-times" aria-hidden="true"></i> <span>是否第一发明人</span>
									</button></li>
							</ul>
						</div>
